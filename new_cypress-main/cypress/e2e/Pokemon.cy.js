describe('Покупка аватара', function () {                                // название набора тестов
    it('e2e тест на покупку нового аватара для тренера', function () {   // название теста
         ...
         cy.get(':nth-child(1) > .auth__input').type('al.susina@yandex.ru');  // вводим логин
         cy.get('#password').type('hnf2193_Ka');       // вводим пароль
         ...
         cy.get('.k_input_name').type('Aлёна');                           // вводим имя владельца действия карты
